...
# This file duplicates the "multi_head_attention_forward" function and "multi_head_attention" class from pytorch
...
# COPIED FROM torch.nn.functional
def scaled_dot_product_attention_training(
    q: Tensor,
    k: Tensor,
    v: Tensor,
    pi: Tensor,
    ...
    pi_attn_mask.masked_fill_(pi.permute(1, 2, 0).le(0), float("-inf"))
